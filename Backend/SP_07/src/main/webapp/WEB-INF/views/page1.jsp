    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="/logout" style="background-color: white; color:#008299; font-weight: bold; ">·Î±×¾Æ¿ô</a></li>
                    </ul>
                </div>
            </div>
        </nav>
        ...
        <header class="masthead bg-white text-black text-center">
            <div class="container d-flex align-items-center flex-column">
                <h1 class="page-section-heading text-center text-uppercase text-secondary mb-0 " style="font-size: 20">File Upload</h1>
                <!-- Icon Divider-->
                ...
                <form action="/page2" enctype="multipart/form-data"> <!-- method = post -->
                    <div class="text-center mt-4">
                        <input type="file" name="filename" class="lead"><br/>
                    </div>
                    <div class="text-center mt-4">
                        <input type="submit" class="btn btn-xl btn-outline-light" value="Upload complete" style="background-color: lightgray; color:black;">
                    </div>
                </form>
            </div>
        </header>
